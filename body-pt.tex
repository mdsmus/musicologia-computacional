...
de notas que soam simultaneamente \note{Acho importante dizer que se
  uma nota é alterada o segmento muda}. Para detectar a resolução das
...
\begin{figure}
  \centering
  \subfigure[Nota mais aguda do Soprano]{\includegraphics[scale=3]{334-soprano-agudo}}
  \subfigure[Nota mais grave do Soprano]{\includegraphics[scale=3]{175-soprano-grave}}
  \subfigure[Nota mais aguda do Contralto]{\includegraphics[scale=3]{024-contralto-agudo}}
  \subfigure[Nota mais grave do Contralto]{\includegraphics[scale=3]{186-contralto-grave}}
  \subfigure[Nota mais aguda do Tenor]{\includegraphics[scale=3]{083-tenor-agudo}}
  \subfigure[Nota mais grave do Tenor]{\includegraphics[scale=3]{229-tenor-grave}}
  \subfigure[Nota mais aguda do Baixo]{\includegraphics[scale=3]{331-baixo-agudo}}
  \subfigure[Nota mais grave do Baixo]{\includegraphics[scale=3]{034-baixo-grave}}
  \caption{Âmbitos}
...
na seção \ref{sec:avaliacao} \note{No formato anppom não dá para se
  referir ao número da seção}.
