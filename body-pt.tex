...
musicais usuais em classes de harmonia. Nesse trabalho o livro é
...
estão acima da voz do contralto) \ref{fig:035-cruzamento}, e no coral
290 existe um cruzamento simultâneo de baixo com o tenor e do
contralto com o soprano \ref{fig:290-66-74-cruzamento}.
...
(quintas) e 2, 89, e 279 (oitavas). (vide figura \ref{fig:279-oitava})
Uma possível justificativa é a ``quebra'' de uma frase para
...
\ref{fig:oitavas-e-unissonos}). Para o alívio dos professores de
