...
de notas que soam simultaneamente. Qualquer alteração nesse conjunto
-- uma nota iniciando ou terminando, por exemplo -- cria outro
segmento mínimo. Para detectar a resolução das sétimas, por exemplo, o
\rameau{} primeiro procura todos os segmentos mínimos no coral
desejado que representam acordes com sétima e encontra, nesses
segmentos, as notas que são as sétimas dos acordes. Feito isso, o
