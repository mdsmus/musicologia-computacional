...
\begin{figure}
  \centering
  \subfigure[Soprano agudo]{\includegraphics[scale=3]{334-soprano-agudo}}
  \subfigure[Soprano grave]{\includegraphics[scale=3]{175-soprano-grave}}
  \subfigure[Contralto agudo]{\includegraphics[scale=3]{024-contralto-agudo}}
  \subfigure[Contralto grave]{\includegraphics[scale=3]{186-contralto-grave}}
  \subfigure[Tenor agudo]{\includegraphics[scale=3]{083-tenor-agudo}}
  \subfigure[Tenor grave]{\includegraphics[scale=3]{229-tenor-grave}}
  \subfigure[Baixo agudo]{\includegraphics[scale=3]{331-baixo-agudo}}
  \subfigure[Baixo grave]{\includegraphics[scale=3]{034-baixo-grave}}
  \caption{Âmbitos}
