...
\begin{figure}
  ...
  \subfigure[Nota mais aguda do Contraltoagudo]{\includegraphics[scale=3]{024-contralto-agudo}}
  \subfigure[Nota mais grave do Contraltograve]{\includegraphics[scale=3]{186-contralto-grave}}
  \subfigure[Nota mais aguda do Tenoragudo]{\includegraphics[scale=3]{083-tenor-agudo}}
  \subfigure[Nota mais grave do Tenorgrave]{\includegraphics[scale=3]{229-tenor-grave}}
  \subfigure[Nota mais aguda do Baixoagudo]{\includegraphics[scale=3]{331-baixo-agudo}}
  \subfigure[Nota mais grave do Baixograve]{\includegraphics[scale=3]{034-baixo-grave}}
  \caption{Âmbitos}
