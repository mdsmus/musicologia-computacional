...
sistema \rameau{} \note{citar icmc? kroger: sim kroger: alias nao
  porque é anonimo, colocar uma nota} para análise automática de
harmonia e extração de informação musical. \rameau{} é um framework
para implementação de algoritmos de análise harmônica de partituras
...
quase 78\% x V I onde x é II, IV ou I
...
\bibliography{writing-style,harmonic-analysis,melodic-contour,music-harmony-and-theory,programs,music-scores}
